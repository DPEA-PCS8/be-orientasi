...
/**
 * Entity for tracking changes to FS2 documents
 */
@Data
@SuperBuilder
@NoArgsConstructor
...
@Entity
@Table(name = "his_fs2_changelog")
public class Fs2Changelog extends BaseEntity {
    ...
    @JoinColumn(name = "fs2_document_id", nullable = false)
    @ToString.Exclude
